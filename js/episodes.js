...
var medicalType = {problemTitle:["Medical emergency."], problemPicture: "allCrew.jpg",problemAttribute: ["shieldAttribute" , "firstMateAttribute"] , problemDescription: ["randomName" , "is a trader whom offers your crew a very special ", "randomItem",". "], resultPossitive:"he survives!",
            resultNegative:"Uh oh! the ship blew up :(", problemAnswer:[{optionOneText:"passivo", optionOneShip: "speed", optionOneCrew: "captain"}, "neutralo","aggressivo"]};
...
var randomObjectType = ["randomName" , "randomMadeObject" , "randomItem","shipName","captainName"]; //this has to be manually set to reflect all the var objects below it.
